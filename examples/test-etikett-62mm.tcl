...
# test-etikett-62mm.tcl
#
# Erzeugt ein Test-Etikett 62 x H mm fuer den Brother QL-820
#
# Aufruf:  tclsh test-etikett-62mm.tcl ?hoehe_mm?
# Beispiel: tclsh test-etikett-62mm.tcl 120
# Default:  56mm
...
$pdf text "pdf4tcl + pdfiumtcl  |  62mm QL-820 Test" \
    -x [expr {$W_pt / 2.0}] \
    -y $yf \
    -align center
...
qlpage write img/etikett62.png -format png
pdfium::close $doc
...
puts "PNG: img/etikett62.png  ${iw} x ${ih} px  (62 x ${H_mm} mm)"
